        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    <pre >
                    تسک آزمایشی سبد خرید (خانم فاطمه حبیبی):
...
ارسال اعلان به مدیریت (ایمیل) بعد از ایجاد محصول
    (use product observe and mailtrap, plesae change your email in .env for receiver and config of ypur mailtrap info for send)

بخش سبد خرید:
امکان اضافه و حذف کردن به سبد خرید
امکان مشاهده سبد خرید
امکان حفظ اطلاعات سبد خرید در مراجعات بعدی
امکان اضافه کردن کالا تکراری وجود ندارد

برای راحتی و تسریع در پیاده سازی نیازی به استفاده از ui خاصی وجود ندارد
برای این تسک صرفا API ها مورد نیاز هست و تست از طریق postman
                    </pre>                   
                </div>
